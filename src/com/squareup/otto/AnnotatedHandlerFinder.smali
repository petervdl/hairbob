...
.method private static loadAnnotatedMethods(Ljava/lang/Class;)V
    ...
    const-string/jumbo v8, " has @Subscribe annotation but requires "
    ...
    const-string/jumbo v8, " arguments.  Methods must require a single argument."
    ...
    const-string/jumbo v8, " has @Subscribe annotation on "
    ...
    const-string/jumbo v8, " which is an interface.  Subscription must be on a concrete class type."
    ...
    const-string/jumbo v8, " but is not \'public\'."
    ...
    const-string/jumbo v8, "has @Produce annotation but requires "
    ...
    const-string/jumbo v8, " arguments.  Methods must require zero arguments."
    ...
    const-string/jumbo v8, " has a return type of void.  Must declare a non-void type."
    ...
    const-string/jumbo v8, " has @Produce annotation on "
    ...
    const-string/jumbo v8, " which is an interface.  Producers must return a concrete class type."
    ...
    const-string/jumbo v8, " has @Produce annotation but has no return type."
    ...
    const-string/jumbo v8, "Producer for type "
    ...
    const-string/jumbo v8, " has already been registered."
