...
.method private static findPlatform()Lcom/squareup/okhttp/internal/Platform;
    ...
    :try_end_b
    .catch Ljava/lang/NoSuchMethodException; {:try_start_0 .. :try_end_b} :catch_52
    ...
    :try_end_12
    .catch Ljava/lang/ClassNotFoundException; {:try_start_c .. :try_end_12} :catch_59
    .catch Ljava/lang/NoSuchMethodException; {:try_start_c .. :try_end_12} :catch_fc
    ...
    invoke-virtual {v3, v1, v8}, Ljava/lang/Class;->getMethod(Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    :try_end_30
    .catch Ljava/lang/ClassNotFoundException; {:try_start_13 .. :try_end_30} :catch_6e
    .catch Ljava/lang/NoSuchMethodException; {:try_start_13 .. :try_end_30} :catch_fc
    ...
    :try_start_31
    const-string/jumbo v1, "setNpnProtocols"
    ...
    const-string/jumbo v1, "getNpnSelectedProtocol"
    ...
    :try_end_50
    .catch Ljava/lang/NoSuchMethodException; {:try_start_31 .. :try_end_50} :catch_62
    .catch Ljava/lang/ClassNotFoundException; {:try_start_31 .. :try_end_50} :catch_6e
    ...
    :try_end_6d
    .catch Ljava/lang/ClassNotFoundException; {:try_start_5a .. :try_end_6d} :catch_6e
    .catch Ljava/lang/NoSuchMethodException; {:try_start_5a .. :try_end_6d} :catch_fc
    ...
    :goto_6f
    :try_start_6f
    const-string/jumbo v17, "org.eclipse.jetty.npn.NextProtoNego"
    ...
    const-string/jumbo v8, "$ClientProvider"
    ...
    const-string/jumbo v8, "$ServerProvider"
    ...
    :try_end_ef
    .catch Ljava/lang/ClassNotFoundException; {:try_start_6f .. :try_end_ef} :catch_f1
    .catch Ljava/lang/NoSuchMethodException; {:try_start_6f .. :try_end_ef} :catch_fa
...
.method public newDeflaterOutputStream(Ljava/io/OutputStream;Ljava/util/zip/Deflater;Z)Ljava/io/OutputStream;
    ...
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_0 .. :try_end_34} :catch_3f
    .catch Ljava/lang/InstantiationException; {:try_start_0 .. :try_end_34} :catch_59
    .catch Ljava/lang/IllegalAccessException; {:try_start_0 .. :try_end_34} :catch_60
