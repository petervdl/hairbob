...
.method private deleteTestAccount(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 432
    const-string/jumbo v5, "FacebookSDK.TestSession"

    const-string/jumbo v6, "Could not delete test account %s: %s"
    ...
    .line 433
    :cond_40
    const-string/jumbo v5, "FACEBOOK_NON_JSON_RESULT"
    ...
    const-string/jumbo v6, "Could not delete test account %s: unknown reason"
...
.method private static declared-synchronized retrieveTestAccountsForAppIfNeeded()V
    ...
    .line 228
    const-string/jumbo v11, "SELECT id,access_token FROM test_account WHERE app_id = %s"
    ...
    const-string/jumbo v10, "SELECT uid,name FROM user WHERE uid IN (SELECT id FROM #test_accounts)"
    ...
    :try_end_27
    .catchall {:try_start_9 .. :try_end_27} :catchall_6d
    ...
    const-string/jumbo v11, "test_accounts"
    ...
    :try_end_38
    .catch Lorg/json/JSONException; {:try_start_27 .. :try_end_38} :catch_70
    .catchall {:try_start_27 .. :try_end_38} :catchall_6d

    .line 244
    :try_start_38
    const-string/jumbo v13, "q"

    instance-of v11, v3, Lorg/json/JSONObject;
    ...
    throw v11
    :try_end_6d
    .catchall {:try_start_38 .. :try_end_6d} :catchall_6d
    ...
    const-string/jumbo v13, "Unexpected number of results from FQL query"
    ...
    :try_end_c1
    .catchall {:try_start_71 .. :try_end_c1} :catchall_6d
