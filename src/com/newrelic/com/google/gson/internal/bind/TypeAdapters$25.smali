...
.method public read(Lcom/newrelic/com/google/gson/stream/JsonReader;)Lcom/newrelic/com/google/gson/JsonElement;
    ...
    .prologue
    .line 644
    sget-object v3, Lcom/newrelic/com/google/gson/internal/bind/TypeAdapters$32;->$SwitchMap$com$google$gson$stream$JsonToken:[I

    invoke-virtual {p1}, Lcom/newrelic/com/google/gson/stream/JsonReader;->peek()Lcom/newrelic/com/google/gson/stream/JsonToken;

    move-result-object v4

    invoke-virtual {v4}, Lcom/newrelic/com/google/gson/stream/JsonToken;->ordinal()I
    ...
    invoke-direct {v0, v3}, Lcom/newrelic/com/google/gson/JsonPrimitive;-><init>(Ljava/lang/String;)V
    ...
    new-instance v3, Lcom/newrelic/com/google/gson/internal/LazilyParsedNumber;

    invoke-direct {v3, v1}, Lcom/newrelic/com/google/gson/internal/LazilyParsedNumber;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v3}, Lcom/newrelic/com/google/gson/JsonPrimitive;-><init>(Ljava/lang/Number;)V
    ...
    invoke-direct {v0, v3}, Lcom/newrelic/com/google/gson/JsonPrimitive;-><init>(Ljava/lang/Boolean;)V
    ...
    .line 664
    .end local v0    # "array":Lcom/newrelic/com/google/gson/JsonArray;
    :pswitch_5c
    ...
    .line 665
    .local v2, "object":Lcom/newrelic/com/google/gson/JsonObject;
...
.method public write(Lcom/newrelic/com/google/gson/stream/JsonWriter;Lcom/newrelic/com/google/gson/JsonElement;)V
    ...
    .line 686
    invoke-virtual {v3}, Lcom/newrelic/com/google/gson/JsonPrimitive;->getAsNumber()Ljava/lang/Number;

    move-result-object v4

    invoke-virtual {p1, v4}, Lcom/newrelic/com/google/gson/stream/JsonWriter;->value(Ljava/lang/Number;)Lcom/newrelic/com/google/gson/stream/JsonWriter;
    ...
    .line 688
    invoke-virtual {v3}, Lcom/newrelic/com/google/gson/JsonPrimitive;->getAsBoolean()Z

    move-result v4

    invoke-virtual {p1, v4}, Lcom/newrelic/com/google/gson/stream/JsonWriter;->value(Z)Lcom/newrelic/com/google/gson/stream/JsonWriter;

    goto :goto_b

    .line 690
    :cond_32
    invoke-virtual {v3}, Lcom/newrelic/com/google/gson/JsonPrimitive;->getAsString()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p1, v4}, Lcom/newrelic/com/google/gson/stream/JsonWriter;->value(Ljava/lang/String;)Lcom/newrelic/com/google/gson/stream/JsonWriter;
    ...
    invoke-virtual {v4}, Lcom/newrelic/com/google/gson/JsonArray;->iterator()Ljava/util/Iterator;
    ...
    invoke-virtual {v4}, Lcom/newrelic/com/google/gson/JsonObject;->entrySet()Ljava/util/Set;
    ...
    .line 703
    .local v1, "e":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/newrelic/com/google/gson/JsonElement;>;"
    ...
    invoke-virtual {p1, v4}, Lcom/newrelic/com/google/gson/stream/JsonWriter;->name(Ljava/lang/String;)Lcom/newrelic/com/google/gson/stream/JsonWriter;
    ...
    invoke-virtual {p0, p1, v4}, Lcom/newrelic/com/google/gson/internal/bind/TypeAdapters$25;->write(Lcom/newrelic/com/google/gson/stream/JsonWriter;Lcom/newrelic/com/google/gson/JsonElement;)V

    goto :goto_74

    .line 706
    .end local v1    # "e":Ljava/util/Map$Entry;, "Ljava/util/Map$Entry<Ljava/lang/String;Lcom/newrelic/com/google/gson/JsonElement;>;"
    :cond_93
